[![Build Status](https://dev.azure.com/snnd/recipes/_apis/build/status/snncoding.recipes?branchName=main)](https://dev.azure.com/snnd/recipes/_build/latest?definitionId=2&branchName=main)
